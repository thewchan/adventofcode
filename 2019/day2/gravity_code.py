"""Determining the input needed to generate the gravity assist output.
...
from computer import computer, get_optcodes
...
def main():
    """Read target code, run decoder, output input code."""
    ...
    noun, verb = decode(target, optcodes)
